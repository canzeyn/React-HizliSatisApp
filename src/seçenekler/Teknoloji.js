...
const Teknoloji = () => {
  ...
  const teknolojikÜrünler = useSelector((state) => state.urunler.ürünler.teknolojikÜrünler);
  ...
  return (
    <div className="bg-stone-50" >
      ...
      <div className=" grid grid-rows-auto grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mt-2  mr-2 ml-2">
        {teknolojikÜrünler.filter((urun) => urun.productName.toLowerCase().includes(searchTerm.toLowerCase())).map((urun) => (
